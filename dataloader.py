...
class DataBone(Dataset):
    def __init__(self, args_d, mode):
        ...
        if self.mode == 'train':
            self.dir_img = args_d['dir_data'] + args_d['dir_train_img']
            self.dir_mask = args_d['dir_data'] + args_d['dir_train_mask']
        elif self.mode == 'val':
            self.dir_img = args_d['dir_data'] + args_d['dir_eval_img']
            self.dir_mask = args_d['dir_data'] + args_d['dir_eval_mask']
...
if __name__ == "__main__":
    ...
    args_d = {'dir_data': 'data/subchondral_patches/',
              'dir_train_img': 'train_imgs/',
              'dir_train_mask': 'train_masks/',
              'dir_eval_img': 'eval_imgs/',
              'dir_eval_mask': 'eval_masks/',
              'copy_channel': True}
